...
auto number_to_readable_name(uint32_t number) -> std::string
{
    static const char* starts[]{
        "N", "Al", "Aver", "B", "Ch", "D", "Ell", "Ev", "F", "G", "Gr", "H", "Iv", "J", "K", "L", "M", "P", "Pr", "Qu",
        "R", "S", "T", "Tr", "V", "W", "Z"};
    static const char* middles[]{
        "u", "a", "ai", "ay", "e", "ee", "el", "en", "i", "ing", "o", "oo", "ou", "or"};
    static const char* ends[]{
        "ll", "b", "ck", "cy", "d", "dy", "gh", "gia", "r", "rie", "l", "le", "liet", "llie", "mer", "nd", "ny", "rd",
        "sly", "son", "ss", "thy", "te", "tt", "xon", "y", "yton", "zz", ""};
    std::stringstream ss;
    ss << starts[number % length_of(starts)];
    number /= length_of(starts);
